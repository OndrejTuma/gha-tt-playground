...
module.exports = eval("require")("node:url");
...
const execa = __webpack_require__(771).execa
...
// EXTERNAL MODULE: (webpack)/ncc/@@notfound.js?node:url
var _notfoundnode_url = __webpack_require__(641);
var _notfoundnode_url_default = /*#__PURE__*/__webpack_require__.n(_notfoundnode_url);
...
function npmRunPath(options = {}) {
	...
	let previous;
	const cwdString = cwd instanceof URL ? _notfoundnode_url_default().fileURLToPath(cwd) : cwd;
	let cwdPath = _notfoundnode_path_default().resolve(cwdString);
	const result = [];
	...
	result.push(_notfoundnode_path_default().resolve(cwdString, execPath, '..'));
...
// EXTERNAL MODULE: ./node_modules/execa/node_modules/signal-exit/index.js
var signal_exit = __webpack_require__(411);
